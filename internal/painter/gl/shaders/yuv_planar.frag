...
uniform vec3 colorRow0;    // R = dot(colorRow0, yuv - colorOffset)
uniform vec3 colorRow1;    // G = dot(colorRow1, yuv - colorOffset)
uniform vec3 colorRow2;    // B = dot(colorRow2, yuv - colorOffset)
uniform vec3 colorOffset;  // subtracted from (Y, U, V) before matrix multiply
